...
Notamment sur : les rares cas d'usage du "string Constructor" et La méthode "String.fromCharCode".
...
In particular: the rare cases of use of the "string Constructor" and the "String.fromCharCode" method.
