...
Notamment sur l'extraction de chaîne de caractères :

Avec les méthodes "slice()" et "substring()"
...
Particularly on string extraction:

With the "slice()" and "substring()" methods
