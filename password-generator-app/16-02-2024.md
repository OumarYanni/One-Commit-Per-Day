...
Notamment sur la modification de chaîne de caractères :

Avec les méthodes "replace()", "split()" et "join()"
...
Particularly on string modification:

With the "replace()", "split()" and "join()" methods.
