...
Notamment sur la comparaison de chaîne de caractères :

Avec les opérateurs "===", "==" et la méthode "localeCompare()"
...
Particularly on string comparison:

With the operators "===", "==" and the "localeCompare()" method.
