...
Notamment sur les expressions régulières et les chaînes de caractères :

Avec les méthodes "match()", "search()" et "replace()"
...
Particularly on regular expressions and strings:

With the "match()", "search()" and "replace()" methods.
