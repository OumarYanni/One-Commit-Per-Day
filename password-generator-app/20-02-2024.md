...
Notamment sur les pièges les plus courant avec les chaînes de caractères :

Coercion des chaînes de caractères et des nombres

Comportement inattendu avec l'espace blanc
...
Particularly on the most common pitfalls with strings:

Coercion of strings and numbers

Unexpected behavior with white space
